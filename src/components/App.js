...
import './App.css'
<<<<<<< HEAD
import Dstswap from '../abis/Dstswap.json'
...
const DST_ABI = IERC20.abi
const DST_ADDRESS = "0x2744363bC62B7C4FDe6866a84889912E7B2FAC85"

const DSTSWAP_ABI = Dstswap.abi
const DSTSWAP_ADDRESS = "0x964EA91C34e2717B4a5dBBc1465753CbdF8ce8D5"
=======
import Dsfswap from '../abis/Dsfswap.json'
//import IERC20 from '../abis/IERC20.json'
import DSF from '../abis/DSF.json'
...
const DSF_ABI = DSF.abi
const DSF_ADDRESS = "0x4EFee4288002113eD24B7d62dEf193955ED186E0"

const DSFSWAP_ABI = Dsfswap.abi
const DSFSWAP_ADDRESS = "0x0acE03FAB14dcD3264A486117EFB83ADDEaeAf91"
...
<<<<<<< HEAD
    const dstToken = new ethers.Contract(DST_ADDRESS, DST_ABI, provider)
    this.setState({ dstToken })
    console.log("DST: ", dstToken.address)

    const dstSwap = new ethers.Contract(DSTSWAP_ADDRESS, DSTSWAP_ABI, accountSigned)
    this.setState({ dstSwap })
    console.log("dstswap: ", dstSwap.address)
=======
    const dsfToken = new ethers.Contract(DSF_ADDRESS, DSF_ABI, provider)
    this.setState({ dsfToken })
    console.log("DSF: ", dsfToken.address)

    const dsfSwap = new ethers.Contract(DSFSWAP_ADDRESS, DSFSWAP_ABI, accountSigned)
    this.setState({ dsfSwap })
    console.log("dsfswap: ", dsfSwap.address)
>>>>>>> cef9dd4 (second commit)
...
=======
    window.alert('After you click the Purchase button, you will be taken to your wallet app where you will be prompted to approve 2 back to back transactions to set & review your USDC spending cap. After you approve the review, please wait until the 3rd prompt appears to and approve that too to execute the Swap transaction. The page will refresh automatically to show your new DSF balance, however you may need to refresh the page manually if required.')    
>>>>>>> cef9dd4 (second commit)
...
<<<<<<< HEAD
      txn = await this.state.token.approve(this.state.dstSwap.address, tokenAmount)
=======
      txn = await this.state.token.approve(this.state.dsfSwap.address, tokenAmount)
>>>>>>> cef9dd4 (second commit)
      txhash = txn.hash
      console.log(txhash)
...
<<<<<<< HEAD
        swaptxn = await this.state.dstSwap.swap(tokenAmount)).then(
=======
        swaptxn = await this.state.dsfSwap.swap(tokenAmount)).then(
>>>>>>> cef9dd4 (second commit)
...
<<<<<<< HEAD
      console.log(this.state.dstToken)
      console.log(this.state.account)
      try {
        balance = await this.state.dstToken.balanceOf(this.state.account)
=======
      console.log(this.state.dsfToken)
      console.log(this.state.account)
      try {
        balance = await this.state.dsfToken.balanceOf(this.state.account)
>>>>>>> cef9dd4 (second commit)
      } catch (e) {
        console.log(e)
      }
